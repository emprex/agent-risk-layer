...
test('paid checkout grants access transactionally and retries report delivery with complete evidence', async () => {
  const session = { id:'cs_v42_resilience', mode:'payment', payment_status:'paid', amount_total:2499, currency:'gbp', customer:'cus_v42', metadata:{user_id:userId,assessment_id:assessmentId,product_key:'pro_report'} };
