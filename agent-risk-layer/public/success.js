...
async function init() {
  try {
    ...
    root.innerHTML = `<div class="success-box">Payment and fulfilment completed.</div><h1 style="font-size:42px">Your access is ready.</h1><p class="muted">${data.purchase?.assessment_id ? 'The report has been generated and email delivery has been attempted. It is also available from your dashboard.' : 'Your subscription is active and available from your dashboard.'}</p><div class="button-row"><a class="button primary" href="/dashboard.html">Open dashboard</a><a class="button ghost" href="/assessment.html">Run an assessment</a></div>`;
