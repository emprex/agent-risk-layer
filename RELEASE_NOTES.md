...
- Reorganises the complete public and authenticated experience around customer outcomes and one recommended next action.
- Standardises role-aware navigation, accessible mobile behaviour, page purpose and calls to action across all 34 pages.
- Preserves runtime protection, exact approvals, inspection, controlled red team, inventory, remediation, retest, evidence, billing and owner workflows through progressive disclosure.
- Adds explicit UX, accessibility, preserved-capability and trust-boundary regression tests.
- Requires manual desktop, mobile and task-completion verification after deployment; no independent usability or accessibility certification is claimed.
