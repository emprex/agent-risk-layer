...
fs.writeFileSync(`${outDir}/AgentRiskLayer-v9.0.0-1000-scenario-results.json`, `${JSON.stringify({ summary, scenarios: rows }, null, 2)}\n`);
fs.writeFileSync(`${outDir}/AgentRiskLayer-v9.0.0-1000-scenario-report.md`, `# AgentRiskLayer v9.0.0 — 1,000-scenario gate
