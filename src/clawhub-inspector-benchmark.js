...
export const BENCHMARK_RELEVANT_RULES = new Set([
  ...
  'ARL-INS-001','ARL-INS-002','ARL-INS-003','ARL-INS-004','ARL-INS-005',
...
export const EXTERNAL_SIGNAL_TO_ARL_RULES = Object.freeze({
  ...
  'static:suspicious.dynamic_code_execution': ['ARL-AI-001','ARL-MCP-001','ARL-INS-003'],
  'static:suspicious.prompt_injection_instructions': ['ARL-INS-001'],
  'static:suspicious.install_untrusted_source': ['ARL-MCP-003','ARL-DEP-002','ARL-DEP-003','ARL-INS-005'],
  'static:suspicious.destructive_delete_command': ['ARL-MCP-001','ARL-AI-001','ARL-INS-003'],
  'static:suspicious.potential_exfiltration': ['ARL-INS-002'],
  ...
  'skillspector:Data Exfiltration': ['ARL-INS-002'],
  'skillspector:Dangerous Code Execution': ['ARL-MCP-001','ARL-AI-001'],
  'skillspector:Rogue Agent': ['ARL-INS-001','ARL-INS-004'],
  'skillspector:Supply Chain': ['ARL-MCP-003','ARL-DEP-002','ARL-DEP-003'],
  'skillspector:Data Flow': [],
  'skillspector:Privilege Escalation': ['ARL-CTR-003','ARL-CTR-004','ARL-MCP-001','ARL-INS-003'],
  'skillspector:Tool Misuse': ['ARL-MCP-001','ARL-AI-001','ARL-AI-007','ARL-INS-003','ARL-INS-004'],
  'skillspector:Excessive Agency': ['ARL-MCP-001','ARL-MCP-002','ARL-AI-007','ARL-INS-004'],
});
